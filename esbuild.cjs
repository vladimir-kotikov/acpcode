...
async function main() {
  const contexts = await Promise.all([
    esbuild.context(webviewBuildOptions("src/webview/main.ts", "dist/webview.js")),
    esbuild.context(webviewBuildOptions("src/webview/sessionView.ts", "dist/sessionView.js")),
  ]);
  if (watch) {
